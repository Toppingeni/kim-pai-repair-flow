...
export function POSelectionDialog({
  ...
  const handleAccept = () => {
    ...
    const newParts = selectedPOItems.filter(part => !existingIds.has(part.id));
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <div className="flex-1">
              <Label htmlFor="po-search" className="text-sm font-medium">
                ค้นหาเลขที่ PO
              </Label>
            ...
            {searchResults.length === 0 ? (
              ...
              <div className="space-y-4">
                {searchResults.map((po) => (
                  <div key={po.poNumber} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <Checkbox
                          checked={isPOFullySelected(po.poNumber)}
                          onCheckedChange={(checked) => 
                            handleSelectAll(po.poNumber, checked as boolean)
                          }
                        />
                        <div>
