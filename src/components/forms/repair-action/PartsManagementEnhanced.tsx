...
export function PartsManagement({
    ...
    const getTypeInfo = (type: string) => {
        return (
            partTypeOptions.find((t) => t.value === type) || partTypeOptions[0]
        );
    };
    ...
    const getTotalCost = () => {
        return parts.reduce((total, part) => {
            return (
                total +
                (part.totalPrice || (part.unitPrice || 0) * part.quantity)
            );
        }, 0);
    };
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <Label className="text-base font-medium">
                            รายการอะไหล่ที่ใช้/สั่งซื้อ ({filteredParts.length}{" "}
                            รายการ)
                        </Label>
                        {/* {parts.length > 0 && (
                                                ...
                                                <div className="space-y-1 w-32">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <Badge
                                                            variant={
                                                                statusConfig[
                                                                    part.status as keyof typeof statusConfig
                                                                ]?.variant ||
                                                                "secondary"
                                                            }
                                                            className="text-xs"
