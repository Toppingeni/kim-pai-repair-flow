...
export const mockSubSpareParts: SubSparePart[] = [
    // Sub parts สำหรับแบริ่ง มอเตอร์ (p1)
    {
        ...
        used: 4,
        unit: "ตัว",
        description: "ลูกปืนสำหรับแบริ่งมอเตอร์",
    },
    {
        id: "sp2",
        sparePartId: "p1",
        ...
        used: 2,
        unit: "ตัว",
        description: "ยางซีลป้องกันฝุ่นและน้ำมัน",
    },
    {
        id: "sp3",
        sparePartId: "p1",
        ...
        used: 1,
        unit: "หลอด",
        description: "กรีสสำหรับหล่อลื่นแบริ่ง",
    },
    ...
    // Sub parts สำหรับยางซีล O-Ring (p9)
    {
        ...
        used: 15,
        unit: "ตัว",
        description: "ยาง NBR สำหรับทำ O-Ring",
    },
    {
        id: "sp5",
        sparePartId: "p9",
        ...
        used: 2,
        unit: "ขวด",
        description: "สารเคลือบผิวป้องกันการสึกหรอ",
    },
    ...
    // Sub parts สำหรับใบมีดคาร์ไบด์ (p14)
    {
        ...
        used: 2,
        unit: "แผ่น",
        description: "วัสดุคาร์ไบด์ทังสเตนสำหรับใบมีด",
    },
    {
        id: "sp7",
        sparePartId: "p14",
        ...
        used: 8,
        unit: "ตัว",
        description: "สกรูยึดใบมีดกับฐาน",
    },
];
...
export const getSubSparePartsBySparePartId = (
    sparePartId: string
): SubSparePart[] => {
    return mockSubSpareParts.filter(
        (subPart) => subPart.sparePartId === sparePartId
    );
};
