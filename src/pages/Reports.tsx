...
import {
    getReportsAllRepairsRows,
    getReportsMachineBreakdown,
            ...
            <div className="p-6 space-y-6">
                <div className="mb-6">
                    ...
                    <p className="text-muted-foreground mt-2">
                        วิเคราะห์ข้อมูลการซ่อมบำรุงและประสิทธิภาพ
                    </p>
                </div>
                        ...
                        <Card className="shadow-card">
                            ...
                            <CardContent>
                                ...
                                <div className="mt-4 text-sm text-muted-foreground">
                                    แสดง {allRepairRequests.length}{" "}
                                    รายการจากทั้งหมด {allRepairRequests.length}{" "}
                                    รายการ
                                </div>
                            </CardContent>
                        </Card>
