            ...
            <div className="flex-1 p-6 space-y-6">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-foreground">
                        รายการใบร้องของานซ่อมของฉัน
                    </h1>
                    <p className="text-muted-foreground">
                        ติดตามสถานะการซ่อมที่คุณแจ้ง
                    </p>
                </div>
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="waiting">
                                            รอยืนยัน ({statusCounts.waiting})
                                        </SelectItem>
                                        <SelectItem value="completed">
                                            ปิดงานแล้ว ({statusCounts.completed}
                                            )
                                        </SelectItem>
                                    </SelectContent>
                                </Select>
                ...
                <RepairTable
                    ...
                    userRole="production"
                    showContactColumn
                    title={`รายการใบร้องของานซ่อม (${filteredRepairs.length} รายการ)`}
                />
            </div>
        </MainLayout>
    );
