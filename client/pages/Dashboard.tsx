...
// ใช้ข้อมูล Mock จากไฟล์รวม (แสดงเฉพาะ 5 รายการล่าสุด)
const mockRepairs = getSimpleRepairs().slice(0, 5);
...
export function Dashboard() {
    ...
    const summaryData =
        userRole === "production"
            ...
            : getEngineeringSummaryData();
    const dashboardTitle =
        userRole === "production"
            ? "ภาพรวมใบสั่งงานซ่อมของคุณ"
            : "ภาพรวมงานแจ้งซ่อม";
    const tableTitle =
        userRole === "production"
            ? "รายการใบร้องของานซ่อมล่าสุด"
            : "งานแจ้งซ่อมที่ต้องดำเนินการ";
