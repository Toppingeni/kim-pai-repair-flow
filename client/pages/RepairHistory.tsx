            ...
            <div className="p-6 space-y-6">
                <div className="mb-6">
                    ...
                    <p className="text-muted-foreground mt-2">
                        ข้อมูลประวัติการซ่อมบำรุงและสถิติการใช้งาน
                    </p>
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        placeholder="รหัสใบสั่งงานซ่อม หรือเครื่องจักร"
                                        className="pl-9"
                                    />
                                </div>
                            </div>
                        ...
                        <CardContent className="p-4">
                            <div className="text-center">
                                <div className="text-2xl font-bold text-status-success">
                                    {(
                                        mockRepairHistory.reduce(
                                            (sum, repair) =>
                                                sum +
                                                parseFloat(repair.downtime),
                                            0
                                        ) / mockRepairHistory.length || 0
                                    ).toFixed(1)}
                                </div>
                                <div className="text-sm text-muted-foreground">
                                    เฉลี่ยชั่วโมง/งาน
                ...
                <Card className="shadow-card">
                    ...
                    <CardContent>
                            ...
                            <TableBody>
                                {mockRepairHistory.map((repair) => (
                                    <TableRow key={repair.id}>
                                        ...
                                        <TableCell>
                                            {repair.startDate.split(" ")[0]} -{" "}
                                            {repair.endDate.split(" ")[0]}
                                        </TableCell>
                        ...
                        <div className="mt-4 flex justify-between items-center">
                            <div className="text-sm text-muted-foreground">
                                แสดง 1-{mockRepairHistory.length} จาก{" "}
                                {mockRepairHistory.length} รายการ
                            </div>
                            <div className="flex space-x-2">
